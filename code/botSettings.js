...
const minimumGold = 10000000;    //  merchant won't go below this amount of gold in wallet
const basicItemsToCraft = ["pants", "pants", "bow", "bow", "bow"];   //  keep buying and upgrading these
